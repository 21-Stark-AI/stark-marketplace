...
---
Usage: stark-terraform-review [path] [--agents claude,codex,gemini] [--changed] [--allow-agent-dispatch] [--include-tfvars] [--trust-source] [--no-tools] [--min-severity ...] [--pr N --repo O/R] [--dry-run] [--json]
