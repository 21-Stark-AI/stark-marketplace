...
description: Multi-domain spec review with lead/wing fix loop. Codex (gpt-5.6-sol, xhigh reasoning) reviews 9 domains in parallel; Claude (opus-5 1m) wing fixes findings. Use for review spec, review architecture.
